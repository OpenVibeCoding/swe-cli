...
async def create_server(server: MCPServerCreate) -> Dict[str, Any]:
    ...
    try:
        ...
        from swecli.mcp.config import save_server_config
...
async def update_server(name: str, update: MCPServerUpdate) -> Dict[str, Any]:
    ...
    try:
        ...
        # Save updated config
        from swecli.mcp.config import save_server_config, get_project_config_path
...
async def delete_server(name: str) -> Dict[str, Any]:
    ...
    try:
        ...
        # Remove from config
        from swecli.mcp.config import remove_server_config, get_project_config_path
