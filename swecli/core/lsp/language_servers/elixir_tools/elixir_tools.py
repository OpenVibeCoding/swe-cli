...
from swecli.core.lsp.ls import SolidLanguageServer
from swecli.core.lsp.ls_config import LanguageServerConfig
from swecli.core.lsp.ls_utils import FileUtils, PlatformId, PlatformUtils
from swecli.core.lsp.lsp_protocol_handler import lsp_types
from swecli.core.lsp.lsp_protocol_handler.lsp_types import InitializeParams
from swecli.core.lsp.lsp_protocol_handler.server import ProcessLaunchInfo
...
class ElixirTools(SolidLanguageServer):
    ...
    def _send_references_request(self, relative_file_path: str, line: int, column: int) -> list[lsp_types.Location] | None:
        ...
        from swecli.core.lsp.ls_utils import PathUtils
