...
from opencli.models.message import ChatMessage
...
class SessionManager:
    ...
    def find_latest_session(self, working_directory: Path | str) -> Optional[SessionMetadata]:
    ...
    def load_latest_session(self, working_directory: Path | str) -> Optional[Session]:
