...
class AppConfig(BaseModel):
    ...
    model: str = "accounts/fireworks/models/glm-4p5-air"
    ...
    # Paths
    opencli_dir: str = "~/.opencli"
    session_dir: str = "~/.opencli/sessions"
    log_dir: str = "~/.opencli/logs"
    command_dir: str = ".opencli/commands"
