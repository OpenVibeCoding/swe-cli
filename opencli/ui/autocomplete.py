...
from .autocomplete_internal.completers import (
    OpenCLICompleter as RefactoredOpenCLICompleter,
...
class OpenCLICompleter(RefactoredOpenCLICompleter):
    """Custom completer for OpenCLI that handles @ mentions and / commands."""
