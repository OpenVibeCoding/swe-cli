"""Welcome banner and session info for OpenCLI."""
...
class WelcomeMessage:
    ...
    def generate_banner(cls) -> List[str]:
        ...
        header = cls._header_line(f"OpenCLI {version}")
    ...
    def generate_full_welcome(
        ...
        left_entries: List[Tuple[str, str]] = [
            ...
            ("OpenCLI ready for your next prompt.", "left"),
        ]
        ...
        return [
            "",
            cls._header_line(f"OpenCLI {version}"),
            *rows,
            cls._footer_line(),
        ]
