...
class ChatApprovalManager:
    ...
    def __init__(self, console, chat_app=None):
        ...
        from opencli.core.approval import ApprovalRulesManager, RuleAction
    ...
    def _check_auto_approval(self, operation, command):
        ...
        """
        from opencli.core.approval import ApprovalResult, ApprovalChoice
        from opencli.models.operation import OperationType
    ...
    def _process_approve_all_choice(self, command, edited_command, matched_rule):
        ...
        """
        from opencli.core.approval import ApprovalResult, ApprovalChoice
        from opencli.core.approval.rules import ApprovalRule, RuleType, RuleAction
