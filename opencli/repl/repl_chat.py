...
from opencli.core.management import ConfigManager, ModeManager, OperationMode, SessionManager
...
from opencli.ui.utils.rich_to_text import rich_to_text_box
from opencli.models.message import ChatMessage, Role
from opencli.repl.repl import REPL  # Import existing REPL for all the logic
from opencli.repl.chat.spinner import ChatSpinner
from opencli.repl.chat.ui_helpers import ChatUIHelpers
from opencli.repl.chat.context_compactor import ContextCompactor
from opencli.repl.chat.approval_manager import ChatApprovalManager
from opencli.repl.chat.async_query_processor import AsyncQueryProcessor
from opencli.repl.chat.tool_executor import ToolExecutor
...
class REPLChatApplication(ChatApplication):
    ...
    def _show_welcome(self) -> None:
        ...
        from opencli.ui.components.welcome import WelcomeMessage
