...
from opencli.core.monitoring import ErrorHandler, TaskMonitor
...
from opencli.ui.components.task_progress import TaskProgressDisplay
...
from opencli.ui.components.notifications import NotificationCenter
from opencli.ui.formatters_internal.markdown_formatter import markdown_to_plain_text
...
class REPL:
    ...
    def _init_prompt_session(self):
        ...
        history_file = Path(self.config.opencli_dir).expanduser() / "history.txt"
